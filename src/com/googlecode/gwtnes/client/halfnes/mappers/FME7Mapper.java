...
import com.googlecode.gwtnes.client.halfnes.audio.FME7SoundChip;
...
public class FME7Mapper extends Mapper {
    ...
    private final ExpansionSoundChip sndchip = new FME7SoundChip();
        ...
        if (addr == 0x8000) {
            ...
            switch (commandRegister) {
                ...
                case 0xc:
                    ...
                    switch (data & 3) {
                        case 0:
                            ppuram.setmirroring(Mapper.MirrorType.V_MIRROR);
                            break;
                        case 1:
                            ppuram.setmirroring(Mapper.MirrorType.H_MIRROR);
                            break;
                        case 2:
                            ppuram.setmirroring(Mapper.MirrorType.SS_MIRROR0);
                            break;
                        case 3:
                            ppuram.setmirroring(Mapper.MirrorType.SS_MIRROR1);
                            break;
                    }
                case 0xd:
